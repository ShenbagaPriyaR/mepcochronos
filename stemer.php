    ...
    class PorterStemmer
    {
        ...
        private static function step1ab($word)
        {
            ...
            if (substr($word, -1) == 's') {
                ...
                OR self::replace($word, 's', 's');  // CHANGED...
            }
            ...
            if (substr($word, -2, 1) != 'e' OR !self::replace($word, 'eed', 'ee', 0)) { // First rule
                ...
                if (   preg_match("#$v+#", substr($word, 0, -3)) && self::replace($word, 'ing', '')
                    ...
                    if (    !self::replace($word, 'ate', '')
                        AND !self::replace($word, 'ble', '')
                        AND !self::replace($word, 'ize', '')) {
        ...
        private static function step1c($word)
        {
            ...
            if (substr($word, -1) == 'y' && preg_match("#$v+#", substr($word, 0, -1))) {
                self::replace($word, 'y', 'y');  // CHANGED..... by us...
            }
